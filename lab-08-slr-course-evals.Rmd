...
1.  Visualize the distribution of `score`.
    ...
    evals %>%
      summarise(mean = mean(score), median = median(score), min = min(score), maxs = max(score), sds = sd(score),
...
***A male professor on average scores 0.14 higher on evaluations than a female. On average a female professor scores 4.09 on the ratings.***
...
***The average rating for a tenured professor is 4.14. The average rating for a teaching professor is  0.14 points higher than a tenure track professor. The average for a tenure track professor is 0.02 points higher than a tenured professor.***
